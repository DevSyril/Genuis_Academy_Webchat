...
<body>
    ...
    <div class="auth-cover-form">
        <form action="/brief/processing/authentification.php" method="post">
            ...
            <input type="email" placeholder="Saisir l'e-mail ici ..." id="email" name="email" required minlength="6"
                maxlength="50">
            <br /><br />
            ...
            <input type="password" placeholder="Confirmer le mot de passe ici ..." id="confirm_password"
